        ...
        return $panel
            ...
            ->renderHook('panels::head.done', fn() => new \Illuminate\Support\HtmlString('
                <style>
                    ...
                    .fi-topbar { background: rgba(5, 5, 5, 0.8) !important; backdrop-filter: blur(20px) !important; border-bottom: 1px solid rgba(255, 255, 255, 0.05) !important; }
            ...
            ->widgets([
                ...
                \App\Filament\Widgets\DriveStats::class,
                \App\Filament\Widgets\StorageUsageChart::class,
            ])
            ->middleware([

#!/usr/bin/env bash
# YG Master — cPanel Deployment Script
set -euo pipefail
...
[[ -f "$APP_ROOT/.env" ]]    || error ".env missing — copy .env.production and configure credentials."

info "Deploying YG Master from $APP_ROOT"
...
success "YG Master deployment complete!"

...
<div class="results-header" style="flex-direction: column; align-items: stretch; padding: 0;">
    <div style="display: flex; align-items: center; gap: 30px; padding: 12px 40px;">
        <a href="<?php echo e(route('search.home')); ?>" class="mini-logo">YGX<span>ONE</span></a>
        
        <div class="search-input-wrapper">
            <i class="fas fa-search mini-search-icon"></i>
            <form action="<?php echo e(route('search.index')); ?>" method="GET" style="display: flex; align-items: center; width: 100%;">
                <input type="text" name="q" value="<?php echo e($query); ?>" class="mini-search-bar" placeholder="Ask Yuga AI...">
        ...
        <div class="nav-links" style="display: flex; gap: 20px; margin-left: auto;">
            ...
            <?php if(auth()->check()): ?>
                <a href="https://account.ygxone.com" class="profile-btn" style="background: #2563eb; color: #fff; width: 32px; height: 32px; border-radius: 50%; display: flex; items-center justify-center; font-size: 14px;">
                    <?php echo e(substr(auth()->user()->name ?? 'P', 0, 1)); ?>
    ...
    <div style="display: flex; gap: 25px; padding: 0 40px 0 160px; border-top: 1px solid #f1f5f9;">
        <a href="?q=<?php echo e(urlencode($query)); ?>&type=ai" class="py-3 px-1 text-sm font-medium flex items-center gap-2 <?php echo e($type == 'ai' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-blue-600'); ?>">
            <i class="fas fa-sparkles text-[10px]"></i> AI Mode
        </a>
        <a href="?q=<?php echo e(urlencode($query)); ?>&type=all" class="py-3 px-1 text-sm font-medium flex items-center gap-2 <?php echo e(($type == 'all' || $type == 'web') ? 'text-blue-600 border-b-2 border-blue-600 font-bold' : 'text-gray-500 hover:text-blue-600'); ?>">
            <i class="fas fa-search text-[10px]"></i> All
        </a>
        <a href="?q=<?php echo e(urlencode($query)); ?>&type=images" class="py-3 px-1 text-sm font-medium flex items-center gap-2 <?php echo e($type == 'images' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-blue-600'); ?>">
            <i class="fas fa-image text-[10px]"></i> Images
        </a>
        <a href="?q=<?php echo e(urlencode($query)); ?>&type=news" class="py-3 px-1 text-sm font-medium flex items-center gap-2 <?php echo e($type == 'news' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-blue-600'); ?>">
            <i class="fas fa-newspaper text-[10px]"></i> News
        </a>
        <a href="?q=<?php echo e(urlencode($query)); ?>&type=videos" class="py-3 px-1 text-sm font-medium flex items-center gap-2 <?php echo e($type == 'videos' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-blue-600'); ?>">
            <i class="fas fa-play-circle text-[10px]"></i> Videos
        </a>
        <a href="?q=<?php echo e(urlencode($query)); ?>&type=shopping" class="py-3 px-1 text-sm font-medium flex items-center gap-2 <?php echo e($type == 'shopping' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-blue-600'); ?>">
...
<div class="results-container">
    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        <?php if($total_results > 0): ?>
            <p class="text-sm text-gray-600 mb-6">About <?php echo e(number_format($total_results)); ?> results for "<?php echo e(e($query)); ?>"</p>
        <?php else: ?>
            <p class="text-sm text-gray-600 mb-6">No results found for "<?php echo e(e($query)); ?>"</p>
        <?php endif; ?>
            ...
            <div class="flex flex-col md:flex-row gap-8">
                    ...
                    <div class="ai-answer-card" style="background: transparent; border: none; padding: 0; margin-bottom: 20px;">
                        ...
                        <div class="mt-8">
                            ...
                            <div class="space-y-0 border-b">
                                <?php $questions = $results['suggestions']['ai'] ?? ['Who is ' . $query . '?', 'What is ' . $query . ' known for?', 'Latest news on ' . $query]; ?>
                                <?php $__currentLoopData = array_slice($questions, 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="border-t py-4 group cursor-pointer hover:bg-gray-50 transition-colors px-2">
                                    <div class="flex justify-between items-center">
                                        <span class="text-base font-medium text-gray-800"><?php echo e($q); ?></span>
                ...
                <div class="w-full md:w-[360px] flex-shrink-0">
                    <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm sticky top-24">
                        <div class="p-6">
                            <h2 class="text-2xl font-bold text-gray-900 mb-1"><?php echo e(e($query)); ?></h2>
                            ...
                            <div class="space-y-5">
                                ...
                                <?php $__currentLoopData = $facts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="border-t pt-3">
                                    <span class="text-xs font-bold text-gray-400 uppercase tracking-wider"><?php echo e($label); ?></span>
                                    <p class="text-sm text-gray-800 mt-1 font-medium"><?php echo e($value); ?></p>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white p-5 rounded-lg border border-gray-200 hover:shadow-md transition-shadow duration-200">
                    <div class="flex justify-between items-start mb-2">
                        <span class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded text-xs font-bold uppercase border <?php echo e($badgeClass); ?>">
                            <?php if(isset($result['icon'])): ?>
                                <i class="fas fa-<?php echo e(e($result['icon'])); ?>"></i>
                            <?php endif; ?>
                            <?php echo e(ucfirst(e($result['type']))); ?>

                        </span>
                        <?php if(isset($result['metadata']['date'])): ?>
                            <span class="text-xs text-gray-400"><?php echo e(\Carbon\Carbon::parse($result['metadata']['date'])->diffForHumans()); ?></span>
                        <?php endif; ?>
                    </div>
                    <a href="<?php echo e(e($ecoUrl)); ?>" class="block text-lg text-blue-700 hover:underline font-medium mb-1" rel="noopener noreferrer">
                        <?php echo e(e($result['title'])); ?>

                    </a>
                    <p class="text-sm text-gray-600 line-clamp-2"><?php echo e(strip_tags($result['snippet'] ?? '')); ?></p>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div class="group relative aspect-video bg-gray-100 rounded-lg overflow-hidden border border-gray-200 hover:shadow-lg transition-all">
                    ...
                    <div class="absolute inset-0 bg-black/0 group-hover:bg-black/40 transition-colors p-3 flex flex-col justify-end opacity-0 group-hover:opacity-100">
                        <a href="<?php echo e(e($result['url'] ?? '#')); ?>" target="_blank" class="text-white text-xs font-medium line-clamp-2 hover:underline">
                            <?php echo e(e($result['title'] ?? 'Image Result')); ?>

                        </a>
                        <span class="text-gray-300 text-[10px]"><?php echo e(e($result['domain'] ?? '')); ?></span>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            ...
            <div class="space-y-8">
                ...
                <div class="flex flex-col md:flex-row gap-4">
                    <div class="flex-1">
                        ...
                        <a href="<?php echo e(e($result['url'] ?? '#')); ?>" target="_blank" class="text-xl font-semibold text-blue-700 hover:underline block mb-1">
                            <?php echo e(e($result['title'] ?? '')); ?>
                        ...
                        <p class="text-gray-600 text-sm leading-relaxed">
                            <?php echo e(Str::limit(strip_tags($result['snippet'] ?? ''), 220)); ?>
                ...
                <div class="result-card">
                    <div class="result-url">
                        <?php if(isset($result['favicon'])): ?>
                            <img src="<?php echo e(e($result['favicon'])); ?>" class="w-4 h-4 rounded-full" alt="">
                        <?php endif; ?>
                        <span><?php echo e(e($result['domain'] ?? '')); ?></span>
                    </div>
                    <div class="flex gap-4">
                        <div class="flex-1">
                            <a href="<?php echo e(e($result['url'] ?? '#')); ?>" target="_blank" class="result-title">
                                <?php echo e(e($result['title'] ?? '')); ?>

                            </a>
                            <p class="result-snippet">
                                <?php echo e(Str::limit(strip_tags($result['snippet'] ?? ''), 180)); ?>

                            </p>
                        </div>
                        <?php if(isset($result['image']) && $result['image']): ?>
                        <div class="hidden md:block">
                            <img src="<?php echo e(e($result['image'])); ?>" class="w-24 h-24 object-cover rounded-lg border border-gray-100" alt="">
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3">
                <?php $__currentLoopData = $suggestions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $source => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(is_array($items)): ?>
                        ...
                        <a href="?q=<?php echo e(urlencode($item)); ?>" class="flex items-center gap-3 py-2 px-3 hover:bg-gray-50 rounded-lg transition-colors group">
                            <i class="fas fa-search text-gray-300 group-hover:text-blue-500 text-[10px]"></i>
                            <span class="text-sm font-medium text-blue-600 hover:underline"><?php echo e($item); ?></span>
                        </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="mt-20 mb-20 flex flex-col items-center">
            <div class="flex items-center gap-2 mb-4">
                ...
                <a href="?q=<?php echo e(urlencode($query)); ?>&type=<?php echo e($type); ?>&page=<?php echo e($pagination['current_page'] - 1); ?>&per_page=<?php echo e($pagination['per_page']); ?>" 
                ...
                <div class="flex items-center gap-1">
                    <?php for($i = max(1, $pagination['current_page'] - 3); $i <= min($pagination['last_page'], $pagination['current_page'] + 3); $i++): ?>
                        <a href="?q=<?php echo e(urlencode($query)); ?>&type=<?php echo e($type); ?>&page=<?php echo e($i); ?>&per_page=<?php echo e($pagination['per_page']); ?>" 
                           class="w-10 h-10 flex items-center justify-center rounded-full text-sm font-bold transition-all duration-200 
                           <?php echo e($i == $pagination['current_page'] ? 'bg-blue-600 text-white shadow-md shadow-blue-200' : 'text-gray-500 hover:bg-gray-100'); ?>">
                            <?php echo e($i); ?>
            ...
            <div class="text-xs text-gray-400 font-medium tracking-wide uppercase">
                YGXONE Intelligence Index — Page <?php echo e($pagination['current_page']); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home4/ygmarket/ygxone.com/yg-home/resources/views/search/results.blade.php ENDPATH**/ ?>
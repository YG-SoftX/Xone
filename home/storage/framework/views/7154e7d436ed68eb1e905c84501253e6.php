...
<div class="home-wrapper">
    <header>
        <div class="nav-links">
            ...
            <?php if(auth()->check()): ?>
                ...
                <a href="<?php echo e(route('sso.logout')); ?>" class="profile-btn" title="Sign out">
                    <i class="fas fa-sign-out-alt"></i>
                </a>
            <?php else: ?>
                <a href="<?php echo e(route('sso.initiate')); ?>" class="sso-login-btn">
    ...
    <?php if(session('sso_success')): ?>
        <div class="sso-alert sso-alert-success" style="text-align:center">
            <i class="fas fa-check-circle"></i> <?php echo e(session('sso_success')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\YG SoftX\Xone\home\resources\views\search\home.blade.php ENDPATH**/ ?>
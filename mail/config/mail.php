...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | These settings are used by the mail:fetch command to retrieve incoming
    | emails from an IMAP server. Configure these in your .env file.
    |
    */

    'incoming' => [
        'host' => env('MAIL_INCOMING_HOST', env('MAIL_HOST', 'mail.ygxone.com')),

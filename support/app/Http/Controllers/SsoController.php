...
class SsoController extends Controller
{
    ...
    {
        $accountUrl  = rtrim(config('services.yg_account.url', 'https://account.ygxone.com'), '/');
    ...
    public function callback(Request $request): RedirectResponse
    {
        ...
        $apiBase = rtrim(config('services.yg_account.api_base', 'https://account.ygxone.com'), '/');
    ...
    /**
     * Log the user out of the support portal.
     */
